...
final class BodySymbolTests: XCTestCase {
    ...
    func testBodySymbol_prihodWithItogo() {
        #warning("противоречивые тесты, нужно разобраться")
        ...
        let sourses = try? filenames
            .flatMap { filename in
                ...
                .body
                .flatMap { $0.components(separatedBy: "\n") }
                .filter { nil != $0.firstMatch(for: Patterns.itemWithItogoPattern) }
            }
        XCTAssertNil(sourses)
        ...
        XCTAssertEqual("1. Приход товара по накладным\t451.198р41к (из них у нас оплачено фактический 21.346р15к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t922.936р37к (оплаты фактические: 313.570р26к-переводы; 87.091р20к-корпоративная карта; 97.712-наличные из кассы; Итого-498.373р 46к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t 753.950р74к(оплаты фактические: 444.719р 16к -переводы; 75.255р 20к-корпоративная карта; 1.545-наличные из кассы; Итого-521.519р 36к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t 946.056р (оплаты фактические: 475.228р 52к -переводы; 157.455р 85к-корпоративная карта; 0-наличные из кассы; Итого-632.684р 37к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t 739.457; (оплаты фактические: 357.254р 17к -переводы; 80.220р 30к-корпоративная карта; 0-наличные из кассы; Итого-437.474р 47к)\t\t".prihodWithItogo(),
                       .item(title: "1. Приход товара по накладным", value: -437_474.47, comment: "739.457; (оплаты фактические: 357.254р 17к -переводы; 80.220р 30к-корпоративная карта; 0-наличные из кассы; Итого-437.474р 47к)"))
        XCTAssertEqual("1. Приход товара по накладным\t 997.446р; (оплаты фактические: 491.114р 65к -переводы; 114.589р -корпоративная карта; 12.170р -наличные из кассы; Итого-617.873р 65к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t179.108р89к+512.293р(оплаты фактические:199.803р80к-переводы;81.225р35к-корпоративная карта;34.202р-наличные из кассы; Итого-315.231р15к)\t\t".prihodWithItogo(),
        ...
        XCTAssertEqual("1. Приход товара по накладным\t473.128р43к(оплаты фактические:231.572р46к-переводы;51.104р93к-корпоративная карта;2.799р-наличные из кассы; Итого-285.476р39к)\t\t".prihodWithItogo(),
...
final class BodySymbolPatternsTests: XCTestCase {
    ...
    func test_itemWithItogoPattern() {
        ...
        XCTAssertNotNil("1. Приход товара по накладным\t946.056р (оплаты фактические: 475.228р 52к -переводы; 157.455р 85к-корпоративная карта; 0-наличные из кассы; Итого-632.684р 37к)".firstMatch(for: Patterns.itemWithItogoPattern))
    }

    func test_prihodPattern() {
