            ...
            body: [
                [Token<BodySymbol>(source: "Основные расходы:\t\t20%\t8.95%",
                 ...
                 Token<BodySymbol>(source: "1. Аренда торгового помещения\t 200.000 (за август)",
                                   symbol: .item(itemNumber: 1, title: "Аренда торгового помещения", value: 200_000, comment: "(за август)")),
                ...
                [Token<BodySymbol>(source: "Зарплата:\t\t20%\t43.4%",
                 ...
                 Token<BodySymbol>(source: "1.ФОТ\t 960.056( за вторую часть августа и первую  часть сентября)",
                                   symbol: .item(itemNumber: 1, title: "ФОТ", value: 960_056, comment: "( за вторую часть августа и первую  часть сентября)")),
                ...
                [Token<BodySymbol>(source: "Фактический приход товара и оплата товара:\t946.056р\t25%",
                 ...
                 Token<BodySymbol>(source: "1. Приход товара по накладным\t 946.056р (оплаты фактические: 475.228р 52к -переводы; 157.455р 85к-корпоративная карта; 0-наличные из кассы; Итого 632.684р 37к)",
                                   symbol: .item(itemNumber: 1, title: "Приход товара по накладным", value: 632684.37, comment: "946.056р (оплаты фактические: 475.228р 52к -переводы; 157.455р 85к-корпоративная карта; 0-наличные из кассы; Итого 632.684р 37к)")),
                 Token<BodySymbol>(source: "2. Предоплаченный товар, но не отраженный в приходе\tСтудиопак Итого 12.500 (влажные салфетки);",
                                   symbol: .item(itemNumber: 2, title: "Предоплаченный товар, но не отраженный в приходе", value: 12_500, comment: "Студиопак Итого 12.500 (влажные салфетки);")),
                ...
                [Token<BodySymbol>(source: "Прочие расходы:\t\t15%\t16.5%",
                 ...
                 Token<BodySymbol>(source: "1.Налоговые платежи \t26.964",
                                   symbol: .item(itemNumber: 1, title: "Налоговые платежи", value: 26_964, comment: nil)),
                 Token<BodySymbol>(source: "2.Банковское обслуживание\t6.419",
                                   symbol: .item(itemNumber: 2, title: "Банковское обслуживание", value: 6_419, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "4.Банковская комиссия 1.6% за эквайринг\t26.581",
                                   symbol: .item(itemNumber: 4, title: "Банковская комиссия 1.6% за эквайринг", value: 26_581, comment: nil)),
                 Token<BodySymbol>(source: "5.Тайный гость\t-----------------------------",
                                   symbol: .empty),
                 Token<BodySymbol>(source: "6.Обслуживание кассовой программы Айко\t16.336",
                                   symbol: .item(itemNumber: 6, title: "Обслуживание кассовой программы Айко", value: 16_336, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "9.Реклама и IT поддержка\t65.000",
                                   symbol: .item(itemNumber: 9, title: "Реклама и IT поддержка", value: 65_000, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "12.Интернет\t9.000",
                                   symbol: .item(itemNumber: 12, title: "Интернет", value: 9_000, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "16. Текущие мелкие расходы \t1.600",
                                   symbol: .item(itemNumber: 16, title: "Текущие мелкие расходы", value: 1_600, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "20. Чистка вентиляции\t26.250",
                                   symbol: .item(itemNumber: 20, title: "Чистка вентиляции", value: 26_250, comment: nil)),
                 Token<BodySymbol>(source: "21. Обслуживание банкетов\t15.250",
                                   symbol: .item(itemNumber: 21, title: "Обслуживание банкетов", value: 15_250, comment: nil)),
                 Token<BodySymbol>(source: "22. Хэдхантер (подбор пероснала)\t9.720",
                                   symbol: .item(itemNumber: 22, title: "Хэдхантер (подбор пероснала)", value: 9_720, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "24. Стол Тенгиз\t17.905",
                                   symbol: .item(itemNumber: 24, title: "Стол Тенгиз", value: 17_905, comment: nil)),
                 Token<BodySymbol>(source: "25. Стол Игорь\t47.090",
                                   symbol: .item(itemNumber: 25, title: "Стол Игорь", value: 47_090, comment: nil)),
                 Token<BodySymbol>(source: "26. Стол Андрей\t9.550",
                                   symbol: .item(itemNumber: 26, title: "Стол Андрей", value: 9_550, comment: nil)),
                 Token<BodySymbol>(source: "27. Сервис Гуру (система аттестации, за 1 год)\t12.655",
                                   symbol: .item(itemNumber: 27, title: "Сервис Гуру (система аттестации, за 1 год)", value: 12_655, comment: nil)),
                ...
                [Token<BodySymbol>(source: "Расходы на доставку:",
                 ...
                 Token<BodySymbol>(source: "2. Агрегаторы\t18.132",
                                   symbol: .item(itemNumber: 2, title: "Агрегаторы", value: 18_132, comment: nil)),
