            ...
            body: [
                [Token<BodySymbol>(source: "Основные расходы:\t-----------------------------\t25%",
                 ...
                 Token<BodySymbol>(source: "7.Вывоз мусора\t18.000",
                                   symbol: .item(itemNumber: 7, title: "Вывоз мусора", value: 18_000, comment: nil)),
                ...
                [Token<BodySymbol>(source: "Зарплата:\t-----------------------------\t20%",
                 ...
                 Token<BodySymbol>(source: "1.ФОТ общий\t261.978",
                                   symbol: .item(itemNumber: 1, title: "ФОТ общий", value: 261_978, comment: nil)),
                 Token<BodySymbol>(source: "2. ФОТ Бренд, логистика, бухгалтерия\t90.000",
                                   symbol: .item(itemNumber: 2, title: "ФОТ Бренд, логистика, бухгалтерия", value: 90_000, comment: nil)),
                ...
                [Token<BodySymbol>(source: "Фактический приход товара и оплата товара:\t-----------------------------\t30%",
                 ...
                 Token<BodySymbol>(source: "1. Приход товара по накладным\t473.128р43к(оплаты фактические:231.572р46к-переводы;51.104р93к-корпоративная карта;2.799р-наличные из кассы; Итого 285.476р39к)",
                                   symbol: .item(itemNumber: 1, title: "Приход товара по накладным", value: 285_476.39, comment: Optional("473.128р43к(оплаты фактические:231.572р46к-переводы;51.104р93к-корпоративная карта;2.799р-наличные из кассы; Итого 285.476р39к)"))),
                ...
                [Token<BodySymbol>(source: "Прочие расходы:\t\t8%",
                 ...
                 Token<BodySymbol>(source: "4.Банковская комиссия 1.6% за эквайринг\t12.111",
                                   symbol: .item(itemNumber: 4, title: "Банковская комиссия 1.6% за эквайринг", value: 12_111, comment: nil)),
                 Token<BodySymbol>(source: "5.Юридическое сопровождение\t40.000",
                                   symbol: .item(itemNumber: 5, title: "Юридическое сопровождение", value: 40_000, comment: nil)),
                 Token<BodySymbol>(source: "6.Обслуживание кассовой программы\t15.995",
                                   symbol: .item(itemNumber: 6, title: "Обслуживание кассовой программы", value: 15_995, comment: nil)),
                 Token<BodySymbol>(source: "7. Обслуживание хостинга\t2.500",
                                   symbol: .item(itemNumber: 7, title: "Обслуживание хостинга", value: 2_500, comment: nil)),
                 Token<BodySymbol>(source: "8.Аудит Кантора (бухуслуги)\t60.000",
                                   symbol: .item(itemNumber: 8, title: "Аудит Кантора (бухуслуги)", value: 60_000, comment: nil)),
                 Token<BodySymbol>(source: "9. Реклама и IT поддержка\t59.200",
                                   symbol: .item(itemNumber: 9, title: "Реклама и IT поддержка", value: 59_200, comment: nil)),
                 Token<BodySymbol>(source: "10.-----------------------\t----------------",
                                   symbol: .empty),
                 Token<BodySymbol>(source: "11. -----------------------\t-----------------",
                                   symbol: .empty),
                 Token<BodySymbol>(source: "12.Интернет\t3.500",
                                   symbol: .item(itemNumber: 12, title: "Интернет", value: 3_500, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "15.Ремонт и чистка вентиляции\t15.000",
                                   symbol: .item(itemNumber: 15, title: "Ремонт и чистка вентиляции", value: 15_000, comment: nil)),
                 Token<BodySymbol>(source: "16. Текущие мелкие расходы\t1.400",
                                   symbol: .item(itemNumber: 16, title: "Текущие мелкие расходы", value: 1_400, comment: nil)),
                 Token<BodySymbol>(source: "17. Чистка жироуловителей и канализации\t10.139",
                                   symbol: .item(itemNumber: 17, title: "Чистка жироуловителей и канализации", value: 10_139, comment: nil)),
                ...
                [Token<BodySymbol>(source: "Расходы на доставку:\t-----------------------------",
                 ...
                 Token<BodySymbol>(source: "2. Агрегаторы\t9.528",
                                   symbol: .item(itemNumber: 2, title: "Агрегаторы", value: 9_528, comment: nil)),
