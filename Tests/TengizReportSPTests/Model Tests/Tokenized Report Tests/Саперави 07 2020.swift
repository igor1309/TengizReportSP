            ...
            body: [
                [Token<BodySymbol>(source: "Основные расходы:\t\t25%",
                 ...
                 Token<BodySymbol>(source: "1. Аренда торгового помещения\t46.667 (за июнь)",
                                   symbol: .item(itemNumber: 1, title: "Аренда торгового помещения", value: 46_667, comment: "(за июнь)")),
                ...
                [Token<BodySymbol>(source: "Зарплата:\t\t22%",
                 ...
                 Token<BodySymbol>(source: "1.ФОТ\t 704.848 ( за вторую часть июня мы выдаем с 10 по 15 июля, а первая часть июля с 25 по 30 июля)",
                                   symbol: .item(itemNumber: 1, title: "ФОТ", value: 704_848, comment: "( за вторую часть июня мы выдаем с 10 по 15 июля, а первая часть июля с 25 по 30 июля)")),
                ...
                [Token<BodySymbol>(source: "Фактический приход товара и оплата товара:\t\t25%",
                 ...
                 Token<BodySymbol>(source: "1. Приход товара по накладным\t922.936р37к (оплаты фактические: 313.570р26к-переводы; 87.091р20к-корпоративная карта; 97.712-наличные из кассы; Итого 498.373р46к)",
                                   symbol: .item(itemNumber: 1, title: "Приход товара по накладным", value: 498_373.46, comment: "922.936р37к (оплаты фактические: 313.570р26к-переводы; 87.091р20к-корпоративная карта; 97.712-наличные из кассы; Итого 498.373р46к)")),
                 Token<BodySymbol>(source: "2. Предоплаченный товар, но не отраженный в приходе\tБейсболки персонал-18.000; Подушки в зал-22.400; Итого 40.400",
                                   symbol: .item(itemNumber: 2, title: "Предоплаченный товар, но не отраженный в приходе", value: 40_400, comment: "Бейсболки персонал-18.000; Подушки в зал-22.400; Итого 40.400")),
                ...
                [Token<BodySymbol>(source: "Прочие расходы:\t\t8%",
                 ...
                 Token<BodySymbol>(source: "2.Банковское обслуживание\t5.778",
                                   symbol: .item(itemNumber: 2, title: "Банковское обслуживание", value: 5_778, comment: nil)),
                 Token<BodySymbol>(source: "3.Юридическое сопровождение\t20.000",
                                   symbol: .item(itemNumber: 3, title: "Юридическое сопровождение", value: 20_000, comment: nil)),
                 Token<BodySymbol>(source: "4.Банковская комиссия 1.6% за эквайринг\t12.785",
                                   symbol: .item(itemNumber: 4, title: "Банковская комиссия 1.6% за эквайринг", value: 12_785, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "9. Реклама и IT поддержка\t104.000",
                                   symbol: .item(itemNumber: 9, title: "Реклама и IT поддержка", value: 104_000, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "14. Контур (эл.отчетность)\t3.000",
                                   symbol: .item(itemNumber: 14, title: "Контур (эл.отчетность)", value: 3_000, comment: nil)),
                 Token<BodySymbol>(source: "15.Аренда зарядных устройств и раций\t-----------------------------",
                                   symbol: .empty),
                 Token<BodySymbol>(source: "16. Текущие мелкие расходы \t2.910",
                                   symbol: .item(itemNumber: 16, title: "Текущие мелкие расходы", value: 2_910, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "18. Регистрация Кассового аппарата (запасной)\t2.000",
                                   symbol: .item(itemNumber: 18, title: "Регистрация Кассового аппарата (запасной)", value: 2_000, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "22. Хэдхантер (подбор пероснала)\t3.240",
                                   symbol: .item(itemNumber: 22, title: "Хэдхантер (подбор пероснала)", value: 3_240, comment: nil)),
                 ...
                 Token<BodySymbol>(source: "24. Столы Тенгиза\t6.100",
                                   symbol: .item(itemNumber: 24, title: "Столы Тенгиза", value: 6_100, comment: nil)),
                 Token<BodySymbol>(source: "25. Стол Игорь\t5.470",
                                   symbol: .item(itemNumber: 25, title: "Стол Игорь", value: 5_470, comment: nil)),
                 Token<BodySymbol>(source: "26. Вино отправляли в подарок\t1.900",
                                   symbol: .item(itemNumber: 26, title: "Вино отправляли в подарок", value: 1_900, comment: nil)),
                ...
                [Token<BodySymbol>(source: "Расходы на доставку:",
                 ...
                 Token<BodySymbol>(source: "2. Агрегаторы\t6.981",
                                   symbol: .item(itemNumber: 2, title: "Агрегаторы", value: 6_981, comment: nil)),
