...
final class ReportContentPatternsTests: XCTestCase {
    ...
    func testReport_body() throws {
        ...
        //        let contents = try SampleFiles.saperavi_2020_07.contentsOfFile()
    ...
    func test_MOVE_IT_TO_GET_SOURCES_AND_RENAME() throws {
        let rows = try SampleFiles.filenames.flatMap { filename -> [String] in
...
struct FileContent {
    ...
    static let allRows: [String] = [
        ...
        " Январь2020\tОборот факт:1.065.575\tСредний показатель:34.373",
        "-------------------------------------------------------------------\t-----------------------------\t\t",
        "----------------------------------------------------------------------\t-----------------------------\t\t",
