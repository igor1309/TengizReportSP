...
extension ReportContent {
    ...
    static var saperavi_2020_06: ReportContent {
        ReportContent(
            header: [
    ...
    static var saperavi_2020_07: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Месяц: июль2020",
    ...
    static var saperavi_2020_08: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Месяц: август2020",
    ...
    static var saperavi_2020_09: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Месяц: сентябрь2020",
    ...
    static var saperavi_2020_10: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Октябрь2020",
    ...
    static var saperavi_2020_11: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Ноябрь2020",
    ...
    static var saperavi_2020_12: ReportContent {
        ReportContent(
            header: [
                "Название объекта: Саперави Аминьевка",
                "Декабрь2020",
    ...
    static var saperavi_2021_01: ReportContent {
        ReportContent(
            header: ["Название объекта: Саперави Аминьевка",
                     "Январь2020",
                     "Оборот:2.307.231",
                     "Средний показатель: 74.426"],
            ...
            footer: ["ИТОГ всех расходов за месяц:\t2.550.334р18к",
    ...
    static var vaiMe_2020_11: ReportContent {
        ReportContent(
            header: [
                "ВМ ЩК",
                "Октябрь+Ноябрь2020",
            ...
            body: ["Основные расходы:\t-----------------------------\t25%/25%\t\n1. Аренда торгового помещения\t-----------------------------\t\t\n2. Эксплуатационные расходы\t-----------------------------\t\t\n3. Электричество\t------------------------------\t\t\n4. Водоснабжение\t-----------------------------\t\t\n5. Аренда головного офиса\t11.500\t\t\n6. Аренда головного склада\t-----------------------------\t\t\n7.Вывоз мусора\t15.800\t\t\nИТОГ:\t27.300\t\t",
                   ...
                   "Расходы на доставку:\t-----------------------------\t\t\n1. Курьеры\t-----------------------------\t\t\n2. Агрегаторы\t8.169\t\t\nИТОГ:\t8.169\t\t"],
            footer: ["ИТОГ всех расходов за месяц:\t695.836р15к",
                     "Фактический остаток:\t684.753р85к",
                     "ИТОГ:\t684.753р85к переносится на декабрь месяц"]
        )
    }

    static var vaiMe_2020_12: ReportContent {
        ReportContent(
            header: [
                "ВМ ЩК",
                "Декабрь2020",
    ...
    static var vaiMe_2021_01: ReportContent {
        ReportContent(
            header: ["ВМ ЩК",
                     "Январь2020",
                     "Оборот факт:1.065.575",
                     "Средний показатель:34.373"],
            ...
            footer: [
                "ИТОГ всех расходов за месяц:\t1.403.460р06к",
                "Фактический остаток:\tМинус 337.885р06к",
                "Остаток с декабря\t693.424р31к",
                "ИТОГ:\t355.539р25к переносим на февраль"
            ]
        )
    }
