...
extension TokenizedReport.Report {
    static let vaiMe_2020_11: TokenizedReport.Report =
        TokenizedReport.Report(
            ...
            groups: [
                Group(groupNumber: 1, title: "Основные расходы", amount: 27_300, target: nil,
                      items: [Item(itemNumber: 5, title: "Аренда головного офиса", amount: 11_500),
                              Item(itemNumber: 7, title: "Вывоз мусора", amount: 15_800)]
                ),

                Group(groupNumber: 2, title: "Зарплата", amount: 157_894, target: 0.2,
                ...
                Group(groupNumber: 3, title: "Фактический приход товара и оплата товара", amount: 315231.15, target: 0.3,
                ...
                Group(groupNumber: 4, title: "Прочие расходы", amount: 214_542, target: 0.08,
                ...
                Group(groupNumber: 5, title: "Расходы на доставку", amount: 8_169, target: nil,
