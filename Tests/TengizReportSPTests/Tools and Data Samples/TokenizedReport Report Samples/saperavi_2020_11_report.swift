...
extension TokenizedReport.Report {
    static let saperavi_2020_11: TokenizedReport.Report =
        TokenizedReport.Report(
            ...
            groups: [
                Group(groupNumber: 1, title: "Основные расходы", amount: 518500.0, target: Optional(0.2),
                ...
                Group(groupNumber: 2, title: "Зарплата", amount: 663678.0, target: Optional(0.2),
                ...
                Group(groupNumber: 3, title: "Фактический приход товара и оплата товара", amount: 437474.47, target: Optional(0.25),
                ...
                Group(groupNumber: 4, title: "Прочие расходы", amount: 393081.12, target: 0.15,
                ...
                Group(groupNumber: 5, title: "Расходы на доставку", amount: 17_839, target: nil,
