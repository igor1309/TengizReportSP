...
extension TokenizedReport.Report {
    static let saperavi_2020_12: TokenizedReport.Report =
        TokenizedReport.Report(
            ...
            groups: [
                Group(groupNumber: 1, title: "Основные расходы", amount: 518_500, target: 0.2,
                ...
                Group(groupNumber: 2, title: "Зарплата", amount: 694_360, target: 0.2,
                ...
                Group(groupNumber: 3, title: "Фактический приход товара и оплата товара", amount: 617_873.65, target: 0.25,
                ...
                Group(groupNumber: 4, title: "Прочие расходы", amount: 582311.24, target: 0.15,
                ...
                Group(groupNumber: 5, title: "Расходы на доставку", amount: 19_131, target: nil,
