        ...
        TokenizedReport.Report(monthStr: "Декабрь2020",
                               ...
                               groups: [
                                ...
                                Group(groupNumber: 0, title: "Прочие расходы", amount: 582311.24, target: 0.15,
                                      items: [Item(itemNumber: 1, title: "Налоговые платежи", amount: 22_895.38, note: nil),
                                              Item(itemNumber: 2, title: "Банковское обслуживание", amount: 7_473.86, note: nil),
                                              Item(itemNumber: 3, title: "Юридическое сопровождение", amount: 40_000, note: nil),
                                              Item(itemNumber: 4, title: "Банковская комиссия 1.6% за эквайринг", amount: 26_915, note: nil),
                                              ...
                                              Item(itemNumber: 9, title: "Реклама и IT поддержка", amount: 82_000, note: nil),
                                              Item(itemNumber: 12, title: "Интернет", amount: 4_500, note: nil),
                                              Item(itemNumber: 14, title: "Облачная касса для доставки через сайт", amount: 36_000, note: nil),
                                              Item(itemNumber: 15, title: "Аренда зарядных устройств и раций", amount: 5_000, note: nil),
                                              Item(itemNumber: 16, title: "Текущие мелкие расходы", amount: 2_600, note: nil),
                                              ...
                                              Item(itemNumber: 21, title: "Обслуживание банкетов", amount: 6_750, note: nil),
                                              ...
                                              Item(itemNumber: 24, title: "Корректировка ЕГАИС", amount: 10_000, note: nil),
                                              Item(itemNumber: 25, title: "Игорь стол", amount: 22_130, note: nil),
                                              Item(itemNumber: 26, title: "Новогодний декор", amount: 169_702, note: nil)]
                                ),
                                
                                Group(groupNumber: 0, title: "Расходы на доставку", amount: 19_131, target: nil,
                                      items: [Item(itemNumber: 1, title: "Курьеры", amount: 4_700, note: nil),
                                              Item(itemNumber: 2, title: "Агрегаторы", amount: 14_431, note: nil)]
                                )
                               ]
        )
}
